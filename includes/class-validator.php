...
class CA_Banners_Validator {
    ...
    public function comprehensive_validate($input) {
        ...
        try {
            ...
            $validated['button_margin_left'] = $this->validate_numeric($input['button_margin_left'] ?? CA_Banners_Constants::DEFAULT_BUTTON_MARGIN_LEFT, CA_Banners_Constants::MIN_BUTTON_MARGIN, CA_Banners_Constants::MAX_BUTTON_MARGIN, CA_Banners_Constants::DEFAULT_BUTTON_MARGIN_LEFT);
            $validated['button_margin_right'] = $this->validate_numeric($input['button_margin_right'] ?? CA_Banners_Constants::DEFAULT_BUTTON_MARGIN_RIGHT, CA_Banners_Constants::MIN_BUTTON_MARGIN, CA_Banners_Constants::MAX_BUTTON_MARGIN, CA_Banners_Constants::DEFAULT_BUTTON_MARGIN_RIGHT);
